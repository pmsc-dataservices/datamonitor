(function(b) {
            ...
            function R() {
                ...
                function V() {
                    ...
                    function aa(ap, ai, ag) {
                        ...
                        var ao = B + Math.round(Math.cos(aj) * (Z+15));
                        var am = p + Math.round(Math.sin(aj) * (Z-20)) * a.series.pie.tilt;
    ...
    var a = {series: {pie: {show: false,radius: "auto",innerRadius: 0,startAngle: 3 / 2,tilt: 1,offset: {top: 0,left: "auto"},stroke: {color: "#FFF",width: 1},label: {show: "auto",formatter: function(d, e) {
                        return '<div style="font-size:x-small;text-align:center;padding:2px;color:' + e.color + ';">' + d + "(" + Math.round(e.percent) + "%)</div>"
