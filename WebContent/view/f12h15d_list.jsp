			...
			<div class="row-fluid sortable">
				<div class="box span12 result">
				  <div class="box-header well" data-original-title>
					  <h2><i class="icon-align-justify"></i>12小时15天精细化预报订正</h2>
					  <div class="box-icon">
				  ...
				  <div class="box-content">
					<div id="mainTab">
						<div>
						<form action="forecast_15day/list?tabType=12h" method="post" id="forecast_12h_15dayForm">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="forecast_12h_15dayTab">
						  <thead>
							  <tr>
							  	  <th>站号</th>
								  <th>站名</th>
