...
public class Page<T> {
	...
	//分页参数
	protected int pageNo = 1;		//当前要显示的第几页 
	protected int pageSize = 6;	//每一页的记录数
	protected String orderBy = null;	//按哪些字段
	protected String order = ASC;		//字段按什么顺序排<升序还是降序>
	protected boolean autoCount = true;	

	//返回结果
	protected List<T> result = null;	//这一页包含要显示的数据
	protected int totalCount = 0;		//总共的记录数
